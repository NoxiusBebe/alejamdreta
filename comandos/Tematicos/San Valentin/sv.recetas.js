...
module.exports = async (client, message, args) => {
  ...
  let estructura = "__Forma de usar el comando:__ `" + client.config.prefijos[message.guild.id] + "sv.recetas`\n" + "```js\n" + "[] -> Obligatorio\n" + "() -> Opcional\n" + "{} -> Aclaración\n" + "```";
  ...
  db_premium.get(`SELECT * FROM premium WHERE servidor = '${message.guild.id}'`, async (err, filas) => {
    ...
    db_tematicos.get(`SELECT * FROM eventos WHERE evento = 'valentin'`, async (err, filas) => {
      ...
      let embed = new Discord.MessageEmbed()
        .setTitle(`:heartbeat: LIBRO DE RECETAS :heartbeat:`)
        .setDescription(`**1. Bombón de chocolate:** chocolate negro\n`+
        `**2. Bombón blanco y negro:** chocolate negro + chocolate blanco\n`+
        `**3. Bombón de frambuesa:** chocolate blanco + frambuesa\n`+
        `**4. Trufa de naranja:** mousse + virutas + naranja\n`+
        `**5. Trufa picante:** mousse + virutas + chile\n`)
        .setColor("#FE4C50")
