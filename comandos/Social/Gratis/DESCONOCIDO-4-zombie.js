...
module.exports = async (client, message, args) => {
  ...
  fetch(`https://discord.com/api/v8/channels/${Canalvoz.id}/invites`, {
      ...
      body: JSON.stringify({
          max_age: tiempo,
          max_uses: 0,
          target_application_id: "519338998791929866",
          target_type: 2,
          temporary: false,
          validate: null
      }),
      ...
      message.channel.send(new Discord.MessageEmbed().setTitle(`:nauseated_face: ¡Gerra Mundial Z! :bat:`).setDescription(`Haced click aquí: <https://discord.gg/${invite.code}>`).setColor(`#FC5F8B`))
  }).catch(e => {
