...
module.exports = async (client, message, args) => {
  ...
  let estructura = "__Forma de usar el comando:__ `" + client.config.prefijos[message.guild.id] + "pesca [elegir: 't' {temporal} o 'p' {permanente}] [conectarse a un canal de voz]`\n" + "```js\n" + "[] -> Obligatorio\n" + "() -> Opcional\n" + "{} -> Aclaración\n" + "```";
  ...
  fetch(`https://discord.com/api/v8/channels/${Canalvoz.id}/invites`, {
      ...
      message.channel.send(new Discord.MessageEmbed().setTitle(`:fishing_pole_and_fish: ¿Jugamos al Fishington.io? :tropical_fish:`).setDescription(`Haced click aquí: <https://discord.gg/${invite.code}>`).setColor(`#FC5F8B`))
  }).catch(e => {
